...
def run_module():
    ...
    # Original way, pylint doesn't like it:
    #module_args = dict(
    #    api_port=dict(type='int', required=False, default=6544),
    ...
    result['comment'] = 'mythtv.general.sample ran'
    result['yet_more_info'] = 'Some other information'
    result['true_false_info'] = false
